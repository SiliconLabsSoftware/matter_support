...
#ifdef SL_BLE_SIDE_CHANNEL_ENABLED
...
#define SL_CATALOG_GLIB_PRESENT // maybe not needed
#define SL_CATALOG_GPIO_PRESENT
#define SL_CATALOG_HAL_EMU_PRESENT
#define SL_CATALOG_I2C_FIFO_PRESENT
...
//maybe need this? #define SL_CATALOG_MPA_MANAGER_PRESENT
